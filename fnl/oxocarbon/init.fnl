...
(custom-set-face! "@lsp.type.namespace.go" [:bold] {:link "@module"})
...
(custom-set-face! "@lsp.type.operator.go" [] {:link "@operator"})
(custom-set-face! "@lsp.type.label.go" [] {:link "@label"})

(custom-set-face! "@lsp.mod.definition.go" [:bold] {})
(custom-set-face! "@lsp.mod.readonly.go" [] {:link "@constant"})
(custom-set-face! "@lsp.mod.defaultLibrary.go" [] {:link "Special"})
(custom-set-face! "@lsp.mod.static.go" [] {:link "@constant"})
(custom-set-face! "@lsp.mod.array.go" [] {:link "Type"})
(custom-set-face! "@lsp.mod.bool.go" [] {:link "@boolean"})
(custom-set-face! "@lsp.mod.chan.go" [] {:link "@keyword"})
(custom-set-face! "@lsp.mod.format.go" [] {:link "@punctuation.special"})
(custom-set-face! "@lsp.mod.interface.go" [] {:link "Structure"})
(custom-set-face! "@lsp.mod.map.go" [] {:link "Type"})
(custom-set-face! "@lsp.mod.number.go" [] {:link "@number"})
(custom-set-face! "@lsp.mod.pointer.go" [] {:link "@operator"})
(custom-set-face! "@lsp.mod.signature.go" [] {:link "@function"})
(custom-set-face! "@lsp.mod.slice.go" [] {:link "Type"})
(custom-set-face! "@lsp.mod.string.go" [] {:link "@string"})
(custom-set-face! "@lsp.mod.struct.go" [] {:link "Structure"})
(custom-set-face! "@lsp.mod.shadowing.go" [:underline] {})

(custom-set-face! "@lsp.typemod.function.defaultLibrary.go" [] {:link "@function.builtin"})
(custom-set-face! "@lsp.typemod.method.defaultLibrary.go" [] {:link "@function.builtin"})
(custom-set-face! "@lsp.typemod.variable.defaultLibrary.go" [] {:link "@variable.builtin"})
(custom-set-face! "@lsp.typemod.variable.readonly.go" [] {:link "@constant"})
(custom-set-face! "@lsp.typemod.variable.static.go" [] {:link "@constant"})
(custom-set-face! "@lsp.typemod.property.readonly.go" [] {:link "@constant"})
(custom-set-face! "@lsp.typemod.string.format.go" [] {:link "@punctuation.special"})
(custom-set-face! "@lsp.typemod.type.definition.go" [:bold] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.typemod.type.interface.go" [] {:link "Structure"})
(custom-set-face! "@lsp.typemod.type.struct.go" [] {:link "Structure"})
