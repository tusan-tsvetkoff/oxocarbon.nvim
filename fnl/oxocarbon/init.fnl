...
(custom-set-face! "@lsp.type.namespace.go" [:bold] {:fg oxocarbon.base07 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.type.go" [] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.typeParameter.go" [] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.parameter.go" [] {:fg oxocarbon.base04 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.property.go" [] {:fg oxocarbon.base10 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.variable.go" [] {:fg oxocarbon.base04 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.function.go" [:bold] {:fg oxocarbon.base12 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.method.go" [] {:fg oxocarbon.base07 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.macro.go" [] {:fg oxocarbon.base07 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.keyword.go" [] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.comment.go" [:italic] {:fg oxocarbon.base03 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.string.go" [] {:fg oxocarbon.base14 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.number.go" [] {:fg oxocarbon.base15 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.operator.go" [] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.type.label.go" [] {:fg oxocarbon.base15 :bg oxocarbon.none})

(custom-set-face! "@lsp.mod.definition.go" [:bold] {})
(custom-set-face! "@lsp.mod.readonly.go" [] {:fg oxocarbon.base14 :bg oxocarbon.none})
(custom-set-face! "@lsp.mod.defaultLibrary.go" [] {:fg oxocarbon.base04 :bg oxocarbon.none})
(custom-set-face! "@lsp.mod.static.go" [] {:fg oxocarbon.base14 :bg oxocarbon.none})
(custom-set-face! "@lsp.mod.array.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@lsp.mod.bool.go" [] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.mod.chan.go" [] {:link "@lsp.type.keyword.go"})
(custom-set-face! "@lsp.mod.format.go" [] {:fg oxocarbon.base08 :bg oxocarbon.none})
(custom-set-face! "@lsp.mod.interface.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@lsp.mod.map.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@lsp.mod.number.go" [] {:link "@lsp.type.number.go"})
(custom-set-face! "@lsp.mod.pointer.go" [] {:link "@lsp.type.operator.go"})
(custom-set-face! "@lsp.mod.signature.go" [] {:link "@lsp.type.function.go"})
(custom-set-face! "@lsp.mod.slice.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@lsp.mod.string.go" [] {:link "@lsp.type.string.go"})
(custom-set-face! "@lsp.mod.struct.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@lsp.mod.shadowing.go" [:underline] {})

(custom-set-face! "@lsp.typemod.function.defaultLibrary.go" [] {:fg oxocarbon.base12 :bg oxocarbon.none})
(custom-set-face! "@lsp.typemod.method.defaultLibrary.go" [] {:fg oxocarbon.base12 :bg oxocarbon.none})
(custom-set-face! "@lsp.typemod.variable.defaultLibrary.go" [] {:fg oxocarbon.base04 :bg oxocarbon.none})
(custom-set-face! "@lsp.typemod.variable.readonly.go" [] {:link "@lsp.mod.readonly.go"})
(custom-set-face! "@lsp.typemod.variable.static.go" [] {:link "@lsp.mod.static.go"})
(custom-set-face! "@lsp.typemod.property.readonly.go" [] {:link "@lsp.mod.readonly.go"})
(custom-set-face! "@lsp.typemod.string.format.go" [] {:link "@lsp.mod.format.go"})
(custom-set-face! "@lsp.typemod.type.definition.go" [:bold] {:fg oxocarbon.base09 :bg oxocarbon.none})
(custom-set-face! "@lsp.typemod.type.interface.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@lsp.typemod.type.struct.go" [] {:link "@lsp.type.type.go"})
...
(custom-set-face! "@comment.go" [] {:link "@lsp.type.comment.go"})
(custom-set-face! "@operator.go" [] {:link "@lsp.type.operator.go"})
(custom-set-face! "@string.go" [] {:link "@lsp.type.string.go"})
(custom-set-face! "@character.go" [] {:link "@lsp.type.string.go"})
(custom-set-face! "@boolean.go" [] {:link "@lsp.mod.bool.go"})
(custom-set-face! "@number.go" [] {:link "@lsp.type.number.go"})
(custom-set-face! "@float.go" [] {:link "@lsp.type.number.go"})
(custom-set-face! "@function.go" [] {:link "@lsp.type.function.go"})
(custom-set-face! "@function.call.go" [] {:link "@lsp.type.function.go"})
(custom-set-face! "@function.builtin.go" [] {:link "@lsp.typemod.function.defaultLibrary.go"})
(custom-set-face! "@function.method.go" [] {:link "@lsp.type.method.go"})
(custom-set-face! "@function.method.call.go" [] {:link "@lsp.type.method.go"})
(custom-set-face! "@method.go" [] {:link "@lsp.type.method.go"})
(custom-set-face! "@method.call.go" [] {:link "@lsp.type.method.go"})
(custom-set-face! "@function.macro.go" [] {:link "@lsp.type.macro.go"})
(custom-set-face! "@keyword.go" [] {:link "@lsp.type.keyword.go"})
(custom-set-face! "@keyword.function.go" [] {:link "@lsp.type.keyword.go"})
(custom-set-face! "@keyword.operator.go" [] {:link "@lsp.type.operator.go"})
(custom-set-face! "@conditional.go" [] {:link "@lsp.type.keyword.go"})
(custom-set-face! "@repeat.go" [] {:link "@lsp.type.keyword.go"})
(custom-set-face! "@label.go" [] {:link "@lsp.type.label.go"})
(custom-set-face! "@include.go" [] {:link "@lsp.type.namespace.go"})
(custom-set-face! "@type.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@type.builtin.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@type.definition.go" [] {:link "@lsp.type.type.go"})
(custom-set-face! "@variable.go" [] {:link "@lsp.type.variable.go"})
(custom-set-face! "@variable.parameter.go" [] {:link "@lsp.type.parameter.go"})
(custom-set-face! "@parameter.go" [] {:link "@lsp.type.parameter.go"})
(custom-set-face! "@property.go" [] {:link "@lsp.type.property.go"})
(custom-set-face! "@field.go" [] {:link "@lsp.type.property.go"})
(custom-set-face! "@variable.member.go" [] {:link "@lsp.type.property.go"})
(custom-set-face! "@constant.go" [] {:link "@lsp.mod.readonly.go"})
(custom-set-face! "@constant.builtin.go" [] {:link "@lsp.mod.defaultLibrary.go"})
(custom-set-face! "@namespace.go" [] {:link "@lsp.type.namespace.go"})
(custom-set-face! "@module.go" [] {:link "@lsp.type.namespace.go"})
