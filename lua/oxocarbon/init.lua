...
vim.api.nvim_set_hl(0, "@lsp.type.namespace.go", {link = "@module", bold = true})
vim.api.nvim_set_hl(0, "@lsp.type.type.go", {link = "@type"})
vim.api.nvim_set_hl(0, "@lsp.type.typeParameter.go", {link = "Typedef"})
vim.api.nvim_set_hl(0, "@lsp.type.parameter.go", {link = "@variable.parameter"})
vim.api.nvim_set_hl(0, "@lsp.type.property.go", {link = "@variable.member"})
vim.api.nvim_set_hl(0, "@lsp.type.variable.go", {})
vim.api.nvim_set_hl(0, "@lsp.type.function.go", {link = "@function"})
vim.api.nvim_set_hl(0, "@lsp.type.method.go", {link = "@function.method"})
vim.api.nvim_set_hl(0, "@lsp.type.macro.go", {link = "Macro"})
vim.api.nvim_set_hl(0, "@lsp.type.keyword.go", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.type.comment.go", {link = "@comment"})
vim.api.nvim_set_hl(0, "@lsp.type.string.go", {})
vim.api.nvim_set_hl(0, "@lsp.type.number.go", {link = "@number"})
vim.api.nvim_set_hl(0, "@lsp.type.operator.go", {link = "@operator"})
vim.api.nvim_set_hl(0, "@lsp.type.label.go", {link = "@label"})
vim.api.nvim_set_hl(0, "@lsp.mod.definition.go", {bold = true})
vim.api.nvim_set_hl(0, "@lsp.mod.readonly.go", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.mod.defaultLibrary.go", {link = "Special"})
vim.api.nvim_set_hl(0, "@lsp.mod.static.go", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.mod.array.go", {link = "Type"})
vim.api.nvim_set_hl(0, "@lsp.mod.bool.go", {link = "@boolean"})
vim.api.nvim_set_hl(0, "@lsp.mod.chan.go", {link = "@keyword"})
vim.api.nvim_set_hl(0, "@lsp.mod.format.go", {link = "@punctuation.special"})
vim.api.nvim_set_hl(0, "@lsp.mod.interface.go", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.mod.map.go", {link = "Type"})
vim.api.nvim_set_hl(0, "@lsp.mod.number.go", {link = "@number"})
vim.api.nvim_set_hl(0, "@lsp.mod.pointer.go", {link = "@operator"})
vim.api.nvim_set_hl(0, "@lsp.mod.signature.go", {link = "@function"})
vim.api.nvim_set_hl(0, "@lsp.mod.slice.go", {link = "Type"})
vim.api.nvim_set_hl(0, "@lsp.mod.string.go", {link = "@string"})
vim.api.nvim_set_hl(0, "@lsp.mod.struct.go", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.mod.shadowing.go", {underline = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.function.defaultLibrary.go", {link = "@function.builtin"})
vim.api.nvim_set_hl(0, "@lsp.typemod.method.defaultLibrary.go", {link = "@function.builtin"})
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.defaultLibrary.go", {link = "@variable.builtin"})
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.readonly.go", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.static.go", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.typemod.property.readonly.go", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.typemod.string.format.go", {link = "@punctuation.special"})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.definition.go", {fg = oxocarbon.base09, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.interface.go", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.struct.go", {link = "Structure"})
...
vim.api.nvim_set_hl(0, "@lsp.typemod.method.definition.go", {link = "@function.method", bold = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.property.definition.go", {link = "@variable.member", bold = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.property.static.go", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.typemod.parameter.definition.go", {link = "@variable.parameter", bold = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.parameter.readonly.go", {link = "@constant"})
...
vim.api.nvim_set_hl(0, "@type.builtin.go", {link = "@type.builtin"})
