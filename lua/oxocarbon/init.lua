...
vim.api.nvim_set_hl(0, "@lsp.type.event", {link = "@constant"})
...
vim.api.nvim_set_hl(0, "@lsp.mod.static", {link = "@constant"})
vim.api.nvim_set_hl(0, "@lsp.mod.interface", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.mod.struct", {link = "Structure"})
...
vim.api.nvim_set_hl(0, "@lsp.typemod.interface.defaultLibrary", {link = "@type.builtin"})
vim.api.nvim_set_hl(0, "@lsp.typemod.interface.interface", {link = "Structure"})
...
vim.api.nvim_set_hl(0, "@lsp.typemod.namespace.defaultLibrary", {link = "@type.builtin"})
...
vim.api.nvim_set_hl(0, "@lsp.typemod.type.definition", {fg = oxocarbon.base09, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.interface", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.struct", {link = "Structure"})
vim.api.nvim_set_hl(0, "@lsp.typemod.typeParameter.defaultLibrary", {link = "@type.builtin"})
...
vim.api.nvim_set_hl(0, "@lsp.type.namespace.go", {fg = oxocarbon.base07, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@lsp.type.type.go", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.typeParameter.go", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.parameter.go", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.property.go", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.variable.go", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.function.go", {fg = oxocarbon.base12, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@lsp.type.method.go", {fg = oxocarbon.base07, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.macro.go", {fg = oxocarbon.base07, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.keyword.go", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.comment.go", {fg = oxocarbon.base03, bg = oxocarbon.none, italic = true})
vim.api.nvim_set_hl(0, "@lsp.type.string.go", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.number.go", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.operator.go", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.type.label.go", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.mod.definition.go", {bold = true})
vim.api.nvim_set_hl(0, "@lsp.mod.readonly.go", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.mod.defaultLibrary.go", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.mod.static.go", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.mod.array.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.bool.go", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.mod.chan.go", {link = "@lsp.type.keyword.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.format.go", {fg = oxocarbon.base08, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.mod.interface.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.map.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.number.go", {link = "@lsp.type.number.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.pointer.go", {link = "@lsp.type.operator.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.signature.go", {link = "@lsp.type.function.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.slice.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.string.go", {link = "@lsp.type.string.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.struct.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.mod.shadowing.go", {underline = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.function.defaultLibrary.go", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.typemod.method.defaultLibrary.go", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.defaultLibrary.go", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.readonly.go", {link = "@lsp.mod.readonly.go"})
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.static.go", {link = "@lsp.mod.static.go"})
vim.api.nvim_set_hl(0, "@lsp.typemod.property.readonly.go", {link = "@lsp.mod.readonly.go"})
vim.api.nvim_set_hl(0, "@lsp.typemod.string.format.go", {link = "@lsp.mod.format.go"})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.definition.go", {fg = oxocarbon.base09, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.interface.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.typemod.type.struct.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@lsp.typemod.typeParameter.definition.go", {fg = oxocarbon.base09, bg = oxocarbon.none, bold = true})
...
vim.api.nvim_set_hl(0, "@comment.go", {link = "@lsp.type.comment.go"})
vim.api.nvim_set_hl(0, "@operator.go", {link = "@lsp.type.operator.go"})
vim.api.nvim_set_hl(0, "@string.go", {link = "@lsp.type.string.go"})
vim.api.nvim_set_hl(0, "@character.go", {link = "@lsp.type.string.go"})
vim.api.nvim_set_hl(0, "@boolean.go", {link = "@lsp.mod.bool.go"})
vim.api.nvim_set_hl(0, "@number.go", {link = "@lsp.type.number.go"})
vim.api.nvim_set_hl(0, "@float.go", {link = "@lsp.type.number.go"})
vim.api.nvim_set_hl(0, "@function.go", {link = "@lsp.type.function.go"})
vim.api.nvim_set_hl(0, "@function.call.go", {link = "@lsp.type.function.go"})
vim.api.nvim_set_hl(0, "@function.builtin.go", {link = "@lsp.typemod.function.defaultLibrary.go"})
vim.api.nvim_set_hl(0, "@function.method.go", {link = "@lsp.type.method.go"})
vim.api.nvim_set_hl(0, "@function.method.call.go", {link = "@lsp.type.method.go"})
vim.api.nvim_set_hl(0, "@method.go", {link = "@lsp.type.method.go"})
vim.api.nvim_set_hl(0, "@method.call.go", {link = "@lsp.type.method.go"})
vim.api.nvim_set_hl(0, "@function.macro.go", {link = "@lsp.type.macro.go"})
vim.api.nvim_set_hl(0, "@keyword.go", {link = "@lsp.type.keyword.go"})
vim.api.nvim_set_hl(0, "@keyword.function.go", {link = "@lsp.type.keyword.go"})
vim.api.nvim_set_hl(0, "@keyword.operator.go", {link = "@lsp.type.operator.go"})
vim.api.nvim_set_hl(0, "@conditional.go", {link = "@lsp.type.keyword.go"})
vim.api.nvim_set_hl(0, "@repeat.go", {link = "@lsp.type.keyword.go"})
vim.api.nvim_set_hl(0, "@label.go", {link = "@lsp.type.label.go"})
vim.api.nvim_set_hl(0, "@include.go", {link = "@lsp.type.namespace.go"})
vim.api.nvim_set_hl(0, "@type.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@type.builtin.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@type.definition.go", {link = "@lsp.type.type.go"})
vim.api.nvim_set_hl(0, "@variable.go", {link = "@lsp.type.variable.go"})
vim.api.nvim_set_hl(0, "@variable.parameter.go", {link = "@lsp.type.parameter.go"})
vim.api.nvim_set_hl(0, "@parameter.go", {link = "@lsp.type.parameter.go"})
vim.api.nvim_set_hl(0, "@property.go", {link = "@lsp.type.property.go"})
vim.api.nvim_set_hl(0, "@field.go", {link = "@lsp.type.property.go"})
vim.api.nvim_set_hl(0, "@variable.member.go", {link = "@lsp.type.property.go"})
vim.api.nvim_set_hl(0, "@constant.go", {link = "@lsp.mod.readonly.go"})
vim.api.nvim_set_hl(0, "@constant.builtin.go", {link = "@lsp.mod.defaultLibrary.go"})
vim.api.nvim_set_hl(0, "@namespace.go", {link = "@lsp.type.namespace.go"})
vim.api.nvim_set_hl(0, "@module.go", {link = "@lsp.type.namespace.go"})
