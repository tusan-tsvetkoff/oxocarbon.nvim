...
vim.api.nvim_set_hl(0, "@lsp.mod.async", {link = "@keyword"})
vim.api.nvim_set_hl(0, "@lsp.mod.declaration", {bold = true})
vim.api.nvim_set_hl(0, "@lsp.mod.defaultLibrary", {link = "Special"})
vim.api.nvim_set_hl(0, "@lsp.mod.definition", {bold = true})
vim.api.nvim_set_hl(0, "@lsp.mod.deprecated", {strikethrough = true})
vim.api.nvim_set_hl(0, "@lsp.mod.documentation", {link = "Comment"})
vim.api.nvim_set_hl(0, "@lsp.mod.modification", {underline = true})
